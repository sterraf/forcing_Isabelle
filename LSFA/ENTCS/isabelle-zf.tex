...
constructors (terms and function with values in \isatt{i}) corresponding to the  empty set
(the constant \isatt{\isadigit{0}}), powersets, and one further constant
...
introduce a new term-former denoting the image of a function
...
Mathematical texts usually start by fixing the context that defines
