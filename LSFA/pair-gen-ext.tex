...
is to prove that the generic extension $M[G]$ is a model of $ZFC$. So, we need to show that
...
In Paulson's library, there exist relative versions of the $ZFC$ axioms. The definition
