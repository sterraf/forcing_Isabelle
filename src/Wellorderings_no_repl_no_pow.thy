...
theory Wellorderings_no_repl_no_pow imports Relative_no_repl_no_pow begin
...
lemma  (in M_basic_no_repl_no_pow) wellfounded_on_iff_wellfounded:
...
lemma (in M_basic_no_repl_no_pow) wellfounded_induct: 
...
lemma (in M_basic_no_repl_no_pow) wellfounded_on_induct: 
...
lemma (in M_basic_no_repl_no_pow) M_Memrel_iff:
     "M(A) ==> 
...
lemma (in M_basic_no_repl_no_pow) Memrel_closed [intro,simp]: 
     "M(A) ==> M(Memrel(A))"
...
lemma (in M_basic_no_repl_no_pow) wellfounded_on_asym:
...
lemma (in M_basic_no_repl_no_pow) wellordered_asym:
