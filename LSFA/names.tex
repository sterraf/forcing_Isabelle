...
\end{equation}
%
As with any recursive definition, in order to justify that the
definition makes sense (i.e., that it defines anything at all) one has
to make explicit the well-founded relation which is used. In this
case, we use the relation $\mathit{ed}$:
\[
