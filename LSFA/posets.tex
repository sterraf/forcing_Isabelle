...
file contaning the most basic results and definitions that follow
...
procedural, goals are refined with the command
...
approach was best because, appart from being more readable, the
reasoning follows mostly in a forward fashion.
