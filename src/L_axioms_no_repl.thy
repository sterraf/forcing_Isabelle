...
theory L_axioms_no_repl imports Formula Relative_no_repl Reflection MetaExists begin
...
apply (simp add: power_ax_def powerset_def Relative_no_repl.subset_def, clarify)
...
apply (simp only: Relative_no_repl.subset_def)
apply (intro FOL_reflections)
done
...
apply (simp only: Relative_no_repl.image_def)
apply (intro FOL_reflections pair_reflection)
done
...
apply (simp only: Relative_no_repl.pre_image_def)
apply (intro FOL_reflections pair_reflection)
done
