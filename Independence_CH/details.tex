...
\item 8 instances for iteration of operations. For each construct,
  ...
  \item Absoluteness of the recursive construction in the proof of the
    Schröder-Bernstein Theorem \isatt{banach{\uscore}iterates{\uscore}fm}.
  \end{itemize}
\item
...
require the following 6 instances (the first two are needed for the $\Delta$-System Lemma):
...
indeed a cardinal).
% https://isabelle.in.tum.de/dist/library/ZF/ZF/CardinalArith.html#CardinalArith.jump_cardinal_def|fact
