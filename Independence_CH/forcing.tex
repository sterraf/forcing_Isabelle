...
Let $\lb \PP, {\preceq} ,\1\rb \in M$ be a forcing notion. The
...
set-theoretic function $\forceisa$, which was defined by using
Isabelle/ZF facilities for primitive recursion.

Next we state the fundamental theorems in compact form.
...
formalization.
Moreover, the statements appear as three separated items in
