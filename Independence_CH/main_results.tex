...
It is to be noted that the \emph{application} of the Forcing Theorems \emph{does not
require any extra replacement}. That is, no further replacement
instance holding at $M$ is necessary to invoke
Theorem~\ref{th:forcing-thms}, independently of the
formula $\phi$. But this seems  not be the case for
Separation, at least from inspecting our formalization: More instances are needed
