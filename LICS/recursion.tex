...
To conclude $M\subseteq M[G]$ one also needs to have $\chk(x) \in M$;
this result requires the internalization of recursively defined
functions. We indicate explicitly where we use this assumption.
