...
theory Separation_no_repl_no_pow imports L_axioms_no_repl_no_pow WF_absolute_no_repl_no_pow begin
...
(* doesn't work by pedro! *)
lemma M_basic_axioms_L: "M_basic_no_repl_no_pow_axioms(L)"
  apply (rule M_basic_no_repl_no_pow_axioms.intro)
