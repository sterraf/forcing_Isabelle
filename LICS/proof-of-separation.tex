...
\cite[IV.2.27]{kunen2011set}, and actually the main technical result,
\begin{isabelle}
\isacommand{lemma}\isamarkupfalse%
...
more lines of bureaucracy in the proof of the last lemma. We preserved the
names of variables used in the textbook, with the occasional question
mark that distinguishes meta-variables. 

Two more
absoluteness results concerning powersets were needed: These are
refinements of results located in \isatt{Relative} that assume that
