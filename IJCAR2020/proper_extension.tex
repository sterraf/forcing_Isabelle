...
incompatible (\isatt{{\isasymbottom}f}) extensions. Here,
\isatt{fun{\isacharunderscore}upd{\isacharparenleft}f{\isacharcomma}x{\isacharparenright}}
adds \isatt{x} to the end of the sequence.
...
\ \ \isakeyword{shows}\ {\isachardoublequoteopen}fun{\isacharunderscore}upd{\isacharparenleft}f{\isacharcomma}{\isadigit{0}}{\isacharparenright}\ {\isasymbottom}f\ fun{\isacharunderscore}upd{\isacharparenleft}f{\isacharcomma}{\isadigit{1}}{\isacharparenright}{\isachardoublequoteclose}
\end{isabelle}
