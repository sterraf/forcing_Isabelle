...
\newcommand{\quine}[1]{\isa{{\isasymcdot}}#1\isa{{\isasymcdot}}}
%\newcommand{\ntrm}[1]{\textsl{\textbf{#1}}}
\newcommand{\Null}{\calN\!\mathit{ull}}
\DeclareMathOperator{\otype}{otype}
\DeclareMathOperator{\club}{Club}
...
\newcommand{\formula}{\isa{formula}}
\newcommand{\forceisa}{\mathop{\mathtt{forces}}}
\newcommand{\concat}{\mathbin{@}}
\newcommand{\ed}{\mathrel{\isa{ed}}}
\newcommand{\frecR}{\mathrel{\isa{frecR}}}
\newcommand{\uscore}{\isacharunderscore}
\newcommand{\forceseq}{\mathop{\isa{forces{\uscore}eq}}}
\newcommand{\forcesmem}{\mathop{\isa{forces{\uscore}mem}}}
\newcommand{\forcesat}{\mathop{\isa{forces{\uscore}at}}}
\newcommand{\frcat}{\mathop{\isa{frc{\uscore}at}}}
