...
Section~\ref{sec:repl-instances}).
...
that we formalized.
% Is the existential quantification here confusing?
\begin{theorem}\label{th:forcing-thms}
  ...
  \end{enumerate}
\end{theorem}
% Describe differences between Kunen's and our approach.
% We can do everything using "internal forcing" (vs. forcing with
% formulas in the metatheory).
