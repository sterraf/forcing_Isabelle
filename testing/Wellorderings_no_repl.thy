...
theory Wellorderings_no_repl imports Relative_no_repl begin
...
lemma  (in M_basic_no_repl) wellfounded_on_iff_wellfounded:
...
lemma (in M_basic_no_repl) wellfounded_induct: 
...
lemma (in M_basic_no_repl) wellfounded_on_induct: 
...
lemma (in M_basic_no_repl) M_Memrel_iff:
     "M(A) ==> 
...
lemma (in M_basic_no_repl) Memrel_closed [intro,simp]: 
     "M(A) ==> M(Memrel(A))"
...
lemma (in M_basic_no_repl) wellfounded_on_asym:
...
lemma (in M_basic_no_repl) wellordered_asym:
