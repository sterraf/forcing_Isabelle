...
\item 6 instances for iteration of operations. For each construct,
  ...
  \end{itemize}
  These instances together with \isatt{tl{\uscore}repl{\uscore}intf{\uscore}fm}
  are needed to instantiate the locales \isatt{M{\uscore}datatypes} and
...
\item
  ...
  \end{itemize}
  The first one is needed for the interpretation of \isatt{M{\uscore}ordertype}.
\item
