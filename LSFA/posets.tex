...
will be necessary in the formalization, we implement a direct proof of the Principle of dependent choices from AC,
and using it we develop a proof of the Rasiowa-Sikorski lemma.
