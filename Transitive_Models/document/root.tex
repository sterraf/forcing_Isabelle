...
As it was explained in \cite[Sect.~3]{2020arXiv200109715G} and elsewhere,
...
to the structure and proof scripts. For this reason, some
comments of the original text as well as outdated \textbf{apply}
commands appear profusely in the following theories.
