...
\fbox{Mover lo siguiente a lo de Values?}
\medskip

A result from the theory \isatt{Names} allows to calculate the value
...
\]
This is then used to show  (lines 221--274 of \isatt{Separation\_Axiom}) that 
\[
