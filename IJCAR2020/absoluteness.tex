...
%
\begin{framed}
  New absoluteness results on powersets --- for \isatt{Least} and
  \isatt{Vset} see Section~\ref{sec:axioms-replacement-choice}
\end{framed}

Apart from the axiom schemes, the rest of the $\ZFC$ 
