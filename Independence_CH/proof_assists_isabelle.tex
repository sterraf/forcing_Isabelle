...
theory~\cite{DBLP:books/daglib/0000395}. The oldest ITP still
still used today is Mizar~\cite{mizar} is far away both in terms
of foundations and architecture; it inspired, though, the Isar
dialect used in nowadays Isabelle.
